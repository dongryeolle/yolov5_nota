...
from models.yolo import ClassificationModel, Detect, Detect_fastest, DetectionModel, SegmentationModel
...
def run(
    ...
    for k, m in model.named_modules():
        if isinstance(m, Detect) or isinstance(m,Detect_fastest):
            m.inplace = inplace
            m.dynamic = dynamic
            m.export = True
            if wo_postprocess:
